...
description: Pełny pipeline projektowania wnętrz mieszkaniowych A-Z — pomieszczenia, wykończenia, instalacje, harmonogram. Aktywuj do projektu całego mieszkania lub urządzenia pomieszczenia. Obejmuje koncept, layout, oświetlenie, instalacje, wykończenia, meble wolnostojące, wizualizacje, plan budowy i zakupy. Wyzwalacze - projekt mieszkania, zaprojektuj pokój, urządzić salon, urządzić sypialnię, urządzić łazienkę, urządzić kuchnię, mieszkanie pod klucz, moodboard, oświetlenie, plan elektryczny, gniazdka, podłoga, mikrocement, panele, farby, tapeta, layout, render wnętrza, meble wolnostojące, kosztorys, harmonogram remontu, lista zakupów. NIE aktywuj do samej zabudowy meblowej (kuchnia/szafa/garderoba/TV na wymiar, rozpiska szafek, formatki) — to skill zabudowa-na-wymiar. Frazy mieszane pomieszczenie+zabudowa ("sypialnia z garderobą") prowadzi ten skill i deleguje zabudowę.
---
