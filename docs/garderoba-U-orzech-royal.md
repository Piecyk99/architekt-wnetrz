...
| **Panel LEWY (lustrzany)** | **Lustro srebrne 4 mm klejone na MDF 14 mm** (folia bezpieczna anti-shatter z tyłu), **rama aluminium czarny mat 20 mm** na obwodzie |
| **Panel PRAWY (lustrzany)** | **Lustro srebrne 4 mm klejone na MDF 14 mm** (folia bezpieczna anti-shatter z tyłu), **rama aluminium czarny mat 20 mm** na obwodzie |
| **Decyzja projektowa** | **DWA lustra pełnej wysokości** na obu panelach drzwi przesuwnych — funkcje: (1) przymiarka z każdej pozycji w chodniku, (2) wizualne podwojenie głębi (chodnik 1.79 m wygląda na ~3.5 m), (3) doświetlenie LED odbija się z całej tylnej ściany |
