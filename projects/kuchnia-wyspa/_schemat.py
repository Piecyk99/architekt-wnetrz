#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Schemat techniczny kuchni U + ramię L, v3.4 — rzut + elewacje (PDF, wektor)."""
import sys
...
c.setTitle("Kuchnia U + ramię L — schemat v3.4")
...
def header(title, sub):
    ...
    c.setFont("DVS", 6.5)
    c.drawString(15 * mm, 8 * mm, "Kuchnia U + ramię L — schemat koncepcyjny v3.4 · 2026-08-12 · wymiary w cm · "
...
header("RZUT Z GÓRY — kuchnia w U z ramieniem L (v3.4)",
...
# okno
ox1, ox2 = 15.5 + 59.7, 15.5 + 59.7 + 85.6   # okno od strony pilastra [P] (korekta v3.4)
...
header("ELEWACJA B — ściana okna (BEZ szafek górnych)",
       "skala ~1:15 · okno pod sam sufit, parapet ~166 · OKNO OD STRONY PILASTRA: 59,7 | 85,6 | 94,7 [P] (v3.4) · od prawej: narożnik z C")
...
e.text(47, H - 140, "górne do sufitu (dół 148) — decyzja inwestora v3.4", 4.4, center=True, col=GREY)
