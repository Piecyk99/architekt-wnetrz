...
MODULES = [
    ...
    ("GA1 górna", 670, 998, 320, "drzwi2g", FR_ORZ, "docinana do pilastra"),
    ("GA2 górna", 450, 998, 320, "drzwi1g", FR_ORZ, ""),
    ("GA3 okap", 600, 998, 320, "okap", FR_ORZ, "konstrukcja wg karty okapu [?]; front uchylny"),
    ("GC1 górna (ociekarka)", 470, 998, 320, "drzwi1g", FR_ORZ, "ociekarka w szafce"),
    ("GC2 górna", 477, 998, 320, "drzwi1g", FR_ORZ, ""),
